...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2023 at 05:15 PM
...
INSERT INTO `users_info` (`id`, `last_name`, `first_name`, `grade`, `subject`, `username`, `password`, `email`, `user_type`, `user_lrn`) VALUES
(1, 'lastname', 'admin', 1, 'Math', 'admin', 'admin', 'jaylingers@gmail.com', 'admin', ''),
(2, 'lastname', 'student', 1, 'one', 'student', 'student', 'jhon@gmail.com', 'student', ''),
(3, 'lastname', 'teacher', 2, 'two', 'teacher', 'teacher', '', 'teacher', ''),
(4, '2', '2', 1, '2', '2', '2', '', '2', ''),
(5, '3', '3', 1, '3', '3', '3', '', '3', ''),
(6, '4', '4', 0, '4', '4', '4', '', '4', ''),
(7, '5', '5', 0, '5', '5', '5', '', '5', ''),
