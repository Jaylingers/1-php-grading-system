...
<div class="d-flex-end p-absolute w-100p bottom-0 t-60px">
    ...
    border-top-left-radius: 5px;">
                        ...
                        $total_pages = $mysqli->query("select * from grade_info order by id desc")->num_rows;
                        // Check if the page number is specified and check if it's a number, if not return the default page number which is 1.
                        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                        // Number of results to show on each page.
                        $num_results_on_page = 10;

                        if ($stmt = $mysqli->prepare("select * from grade_info order by id desc LIMIT ?,?")) {
                            ...
                            <form method="post">
                                ...
                                <div class="d-flex-end pad-1em">
                                    ...
                                    <button type="submit"
                                            ...
                                            name="add_grade" style="background-color: #ffffff !important; border-color: #ffffff;">
                            ...
                            <div id="update-school-year" class="modal-child d-none">
                                <form method="post">
                                    ...
                                    <div class="d-flex-end pad-1em">
                                        ...
                                        <button type="submit"
                                                class="c-hand btn-success btn"
                                                name="update_grade" style="background-color: #ffffff !important; border-color: #ffffff;">
                                            <img src="../../assets/img/add.png" alt="" class="logo1 c-hand" width="50" height="50">
                                        </button>
                                    </div>
                                </form>
