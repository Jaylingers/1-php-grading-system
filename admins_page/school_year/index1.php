...
if(isset($_POST['add_school_year'])) {
    ...
    if ($result) {
        echo '<script>';
        echo '   
                history.pushState({page: "another page"}, "another page", "?id=' . $rows['id'] . '&&added_successfully=' . $school_year . '");
    ...
    border-top-left-radius: 5px;">
                            <div class="custom-grid-container w-100p" tabindex="2">
                                ...
                                <div class="custom-grid-item d-flex-end">
                                    <svg class="c-hand"  onclick="deleteId('school-year-list')" height="43" id="svg2"
                        ...
                        <?php
                        $sql = "select * from school_years_info order by id desc Limit 1";
                        $result = mysqli_query($conn, $sql);
                        ...
                        $total_pages = $mysqli->query("select * from school_years_info order by id desc")->num_rows;
                        // Check if the page number is specified and check if it's a number, if not return the default page number which is 1.
                        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                        // Number of results to show on each page.
                        $num_results_on_page = 10;

                        if ($stmt = $mysqli->prepare("select * from school_years_info order by id desc LIMIT ?,?")) {
                            ...
                            <table class="table table-1 b-shadow-dark">
                                <thead>
                                <tr>
                                    <th class="t-align-center"><label for="school-year-list-cb"
                                                                      class="d-flex-center"></label><input
                                                id="school-year-list-cb" type="checkbox"
                                                onclick="checkAllCB('school-year-list', 'school-year-list-cb')"
                            ...
                            <form method="post">
                                ...
                                <div class="d-flex-end pad-1em">
                                    ...
                                    <button type="submit"
                                            ...
                                            name="add_school_year" style="background-color: #ffffff !important; border-color: #ffffff;">
                            ...
                            <div id="update-school-year" class="modal-child d-none">
                                <form method="post">
                                    ...
                                    <div class="d-flex-end pad-1em">
                                        ...
                                        <button type="submit"
                                                class="c-hand btn-success btn"
                                                name="update_school_year" style="background-color: #ffffff !important; border-color: #ffffff;">
                                            <img src="../../assets/img/add.png" alt="" class="logo1 c-hand" width="50" height="50">
                                        </button>
                                    </div>
                                </form>
