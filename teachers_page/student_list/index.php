...
if (isset($_POST['add-enrollment'])) {
    ...
    if ($result) {
        echo '<script>';
        echo '   
                history.pushState({page: "another page"}, "another page", "?id=' . $_GET['id'] . '&&lrn=' . $lrn . '"&&added_successfully=' . $lrn . '");
                    window.location.reload();
            ';
        echo '</script>';
    }
            ...
            <div class="bg-white w-100p b-radius-10px pad-1em">
                ...
                <div class="m-t-19px m-l-13px f-weight-bold d-flex">
                    ...
                    <div class="r-50px p-absolute t-54px d-flex-center">
                        <img onclick="showModal('add-new-student', 'New Students')" src="../../assets/img/add.png" alt="" class="logo1 c-hand" width="50" height="50">
&nbsp;&nbsp;&nbsp;
        ...
        <div class="modal-body">
                ...
                <form method="post">
                    ...
                    <div class="r-50px d-flex-end gap-1em">
                        <button type="submit"
                                ...
                                name="add-new-student" style="background-color: #ffffff !important; border-color: #ffffff;">
                    ...
                    <div class="b-top-gray-3px m-1em">
                        <div class="r-50px d-flex-end m-t-1em">
                            <label class="btn bg-hover-gray-dark-v1 m-b-0"
                                   onclick="showModal('view-student-info','Student Information', 'dark')" style="padding:0; background-color: #ffffff !important; border-color: #ffffff;">
            ...
            <div id="view-student-enrollment" class="modal-child pad-bottom-2em d-none">
                <div class="d-flex-end m-b-1em">
                    <img onclick="showModal('add-enrollment', 'New Enrollment')" src="../../assets/img/add.png" alt="" class="logo1 c-hand" width="50" height="50">
                    &nbsp;&nbsp;&nbsp;
                        ...
                        <table class="table table-1">
                            ...
                            while ($row = $students_enrollment_info_result->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="t-align-center">
                                        <svg width="40" height="40" class="c-hand" onclick="addGrade('<?= $row['f_name'] ?>','<?= $row['l_name'] ?>','<?= $row['m_name'] ?>','<?= $row['grade'] ?>', '<?= $row['school_year'] ?>')" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="_x35_15_x2C__best_grade_x2C__achieve_x2C__education"><g><polygon points="131,386 131,446 41,416   " style="fill:#57606F;"/><polygon points="41,416 55.25,420.75 131,395.5 131,386   " style="fill:#414A56;"/><path d="M441,386c16.57,0,30,13.43,30,30s-13.43,30-30,30h-30v-60H441z" style="fill:#FF7979;"/><path d="M418.75,394.166h30c6.532,0,12.571,2.094,17.497,5.637C460.911,391.503,451.602,386,441,386h-30v60    h7.75V394.166z" style="fill:#D65B5B;"/><path d="M411,386v60H131v-60H411z M271,426v-20h-20v20H271z M241,426v-20h-20v20H241z M211,426v-20h-20v20    H211z" style="fill:#D7DEED;"/><g><g><g><polygon points="139.25,395 411,395 411,386 131,386 131,446 139.25,446      " style="fill:#AFB9D2;"/></g></g></g><path d="M101,296v50H76c-24.85,0-45-20.15-45-45V111c0-24.85,20.15-45,45-45h25V296z" style="fill:#57606F;"/><path d="M40,309.75v-190c0-24.85,20.15-45,45-45h16V66H76c-24.85,0-45,20.15-45,45v190    c0,14.922,7.271,28.142,18.456,36.329C43.535,329.71,40,320.145,40,309.75z" style="fill:#414A56;"/><path d="M481,111v190c0,24.85-20.15,45-45,45h-25V66h25C460.85,66,481,86.15,481,111z" style="fill:#57606F;"/><path d="M420.166,76.167h25c10.79,0,20.69,3.803,28.443,10.135C465.563,74.077,451.727,66,436,66h-25v280    h9.166V76.167z" style="fill:#414A56;"/><path d="M101,296V66h310v280H101V296z" style="fill:#E8F9F9;"/><polygon points="111.5,307.5 111.5,77.5 411,77.5 411,66 101,66 101,296 101,346 111.5,346   " style="fill:#CCE5E4;"/><path d="M256,106c-41.42,0-75,33.58-75,75s33.58,75,75,75s75-33.58,75-75S297.42,106,256,106z" style="fill:#FEBE76;"/><path d="M188.5,190.42c0-41.42,33.58-75,75-75c21.635,0,41.118,9.174,54.807,23.829    C304.845,119.198,281.965,106,256,106c-41.42,0-75,33.58-75,75c0,19.785,7.675,37.769,20.193,51.171    C193.18,220.236,188.5,205.875,188.5,190.42z" style="fill:#E8A664;"/><polygon points="298.55,172.12 298.55,181.06 289.78,181.06 289.78,190.42 279.47,190.42 279.47,181.06 270.7,181.06     270.7,172.12 279.47,172.12 279.47,162.75 289.78,162.75 289.78,172.12   "/><rect height="20" width="20" x="251" y="406"/><path d="M243.35,147.18l23,58.82h-12.1l-5.62-14.66H227.5L221.97,206h-12.1l23.09-58.82H243.35z M246.5,183.3l-8.35-23.11    l-8.69,23.11H246.5z"/><rect height="20" width="20" x="221" y="406"/><rect height="20" width="20" x="191" y="406"/><path d="M411,451H131c-2.761,0-5-2.238-5-5s2.239-5,5-5h280c2.762,0,5,2.238,5,5S413.762,451,411,451z"/><path d="M411,391H131c-2.761,0-5-2.238-5-5s2.239-5,5-5h280c2.762,0,5,2.238,5,5S413.762,391,411,391z"/><path d="M441,451h-30c-2.762,0-5-2.238-5-5v-60c0-2.762,2.238-5,5-5h30c19.299,0,35,15.701,35,35S460.299,451,441,451z M416,441    h25c13.785,0,25-11.215,25-25s-11.215-25-25-25h-25V441z"/><path d="M131,451c-0.531,0-1.064-0.084-1.581-0.257l-90-30C37.377,420.063,36,418.152,36,416s1.377-4.063,3.419-4.743l90-30    c1.525-0.507,3.201-0.252,4.504,0.687c1.304,0.94,2.077,2.449,2.077,4.057v60c0,1.607-0.772,3.116-2.077,4.057    C133.062,450.678,132.036,451,131,451z M56.812,416L126,439.063v-46.125L56.812,416z"/><path d="M101,351H76c-27.57,0-50-22.43-50-50V111c0-27.57,22.43-50,50-50h25c2.761,0,5,2.239,5,5s-2.239,5-5,5H76    c-22.056,0-40,17.944-40,40v190c0,22.056,17.944,40,40,40h25c2.761,0,5,2.238,5,5S103.761,351,101,351z"/><path d="M436,351h-25c-2.762,0-5-2.238-5-5s2.238-5,5-5h25c22.056,0,40-17.944,40-40V111c0-22.056-17.944-40-40-40h-25    c-2.762,0-5-2.239-5-5s2.238-5,5-5h25c27.57,0,50,22.43,50,50v190C486,328.57,463.57,351,436,351z"/><path d="M411,351H101c-2.761,0-5-2.238-5-5V66c0-2.761,2.239-5,5-5h310c2.762,0,5,2.239,5,5v280C416,348.762,413.762,351,411,351z     M106,341h300V71H106V341z"/><path d="M321,301H101c-2.761,0-5-2.238-5-5s2.239-5,5-5h220c2.762,0,5,2.238,5,5S323.762,301,321,301z"/><path d="M256,261c-44.112,0-80-35.888-80-80s35.888-80,80-80s80,35.888,80,80S300.112,261,256,261z M256,111    c-38.598,0-70,31.402-70,70s31.402,70,70,70c38.598,0,70-31.402,70-70S294.598,111,256,111z"/></g></g><g id="Layer_1"/></svg>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            </tbody>
            ...
            <div id="view-student-grade" class="modal-child d-none">
                ...
                <div class="p-absolute btm-1em r-1em action-button d-flex-center">
                    <label class="btn bg-hover-gray-dark-v1 m-b-0"
                           onclick="backModal('view-student-enrollment', 'Student Enrollment','white')" style="padding:0;background-color: #ffffff !important; border-color: #ffffff;">
                        <img src="../../assets/img/back.png" alt="" width="60" height="60" class="c-hand">
                    </label> &nbsp;&nbsp;
            ...
            <div id="add-student-grade" class="modal-child d-none">
                ...
                <form method="post">
                    ...
                    <div class="p-absolute btm-1em r-1em action-button">
                        ...
                        <button type="submit" class="c-hand btn-primary btn" name="add-student-grade" style="padding:0; background-color: #ffffff !important; border-color: #ffffff;">
                            <img src="../../assets/img/add.png" alt="" class="logo1 c-hand" width="50" height="50">
                        </button>
                    </div>
                </form>
